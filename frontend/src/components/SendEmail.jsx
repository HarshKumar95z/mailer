        ...
        <div className={`${open ? 'block' : 'hidden'} bg-white max-w-6xl shadow-xl shadow-slate-600 rounded-t-md`}>
            ...
            <form onSubmit={submitHandler} className='flex flex-col p-3 gap-2'>
                ...
                <textarea
                    ...
                    className='outline-none py-1'
                ></textarea>
                <button type='submit' className='bg-blue-700 rounded-full px-5 py-1 w-fit text-white'>
                    Send
                </button>
            </form>
        </div>
...
//             <textarea onChange={changeHandler} value={formData.message} name='message' rows={'10'} cols={'50'} className='outline-none py-1'></textarea>

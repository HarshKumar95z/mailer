...
const Signup = () => {
    ...
    const submitHandler = async(e) => {
        e.preventDefault();
        try {
            const res = await axios.post("https://mailer-o6r5.onrender.com/api/v1/user/register", input,{
                headers:{
  ...
  return (
    ...
    <input onChange={changeHandler} value={input.fullname} name='fullname' type='text' placeholder='Name' className='border coredder-gray-400 rounded-md px-2 py-1' />
